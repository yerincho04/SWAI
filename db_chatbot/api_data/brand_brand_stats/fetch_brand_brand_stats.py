#!/usr/bin/env python3
"""Fetch FTC API: brand overview stats, save raw JSON, and export selected fields."""
...
API_URL_CANDIDATES = [
    "https://apis.data.go.kr/1130000/FftcBrandBrandStatsService/getBrandBrandStats",
    "https://apis.data.go.kr/1130000/FftcBrandBrandStatsService/getBrandbrandStats",
    "https://apis.data.go.kr/1130000/FftcBrandBrandStatsService/getbrandBrandStats",
]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch Brand Brand Stats API and export selected columns.")
    ...
    parser.add_argument("--year-fallback-window", type=int, default=2)
    parser.add_argument(
        "--brand-list-json",
        type=Path,
    ...
    parser.add_argument("--no-brand-filter", action="store_true")
    parser.add_argument("--output-dir", type=Path, default=Path("db_chatbot/api_data/brand_brand_stats/output"))
    ...
    raw_path = args.output_dir / "brand_brand_stats_raw.json"
    selected_path = args.output_dir / "brand_brand_stats_selected.json"
    xlsx_path = args.output_dir / "brand_brand_stats.xlsx"
